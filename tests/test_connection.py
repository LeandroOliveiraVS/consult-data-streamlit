...
def test_conectar_banco(mocker):
    ...
    mock_engine.connect.return_value.__enter__.return_value = MagicMock() # Simula o 'with'
    ...
    expected_connection_string = "mysql+pymysql://test_user:test_password@localhost:3306/test_db"
